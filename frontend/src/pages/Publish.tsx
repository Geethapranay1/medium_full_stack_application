...
return<form>
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-white dark:border-gray-600">
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-white">
           ...
           <textarea onChange={onChange} id="editor" rows={10} className=" h-screen block w-full px-0 text-sm text-gray-800 bg-white dark:bg-white dark:text-gray-900 dark:placeholder-gray-400 focus:outline-none" placeholder="Write an article..." required ></textarea>
       </div>
   </div>
